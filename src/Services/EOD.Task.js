export const EOD_Task = (BoardURL, project, board, title, subtitle, subtitle2, notes, link, image, includeHeader=false, borderTop=false) => `
                      ...
                      <tr>
                        <td style="overflow-wrap:break-word;word-break:break-word;padding:5px 10px 0px 0px;font-family:'Open Sans',sans-serif;" align="left">
                          ...
                          <h3 style="margin: 0px; line-height: 140%; text-align: right; word-wrap: break-word; font-weight: normal; font-size: 17px;">
                            <a href="${BoardURL}" style="color: unset !important;
                            text-decoration: none !important;"><strong>${includeHeader ? project : ''}</strong></a>
                          </h3>
                      ...
                      <tr>
                        <td style="overflow-wrap:break-word;word-break:break-word;padding:0px 10px 10px;font-family:'Open Sans',sans-serif;" align="left">
                          ...
                          <h4 style="margin: 0px; color: #000000; line-height: 140%; text-align: right; word-wrap: break-word; font-weight: normal; font-size: 14px;">
                            <a href="${BoardURL}" style="color: unset !important;
                            text-decoration: none !important;"><strong>${includeHeader ? board : ''}</strong></a>
                          </h4>
                    ...
                    <tbody>
                      <tr>
                        <td style="overflow-wrap:break-word;word-break:break-word;padding:5px 10px 0px;font-family:'Open Sans',sans-serif;" align="left">
                          ...
                          <a href="${BoardURL}" style="color: unset !important;
                          text-decoration: none !important;"><strong>${title}</strong></a>
                          </h3>
                        ...
                        <td style="overflow-wrap:break-word;word-break:break-word;padding:0px 10px 10px;font-family:'Open Sans',sans-serif;" align="left">
                          ...
                          <div style="line-height: 140%; text-align: left; word-wrap: break-word;">
                            ...
                            text-decoration: none !important;">
                              <p style="font-size: 14px; line-height: 140%;"><span style="color: #000000; font-size: 14px; line-height: 19.6px;"><strong><span style="font-size: 14px; line-height: 19.6px;"><span style="line-height: 19.6px; font-size: 14px;">${subtitle}</span></span>
                                </strong>
                                </span>
                              </p>
                            </a>
                            ${subtitle2 ? `<a href="${BoardURL}" style="color: unset !important;text-decoration: none !important;">
                              <p style="font-size: 14px; line-height: 140%;"><span style="font-size: 12px; line-height: 16.8px; color: #000000;">
                                <span style="line-height: 16.8px; font-size: 12px;">` + subtitle2 + '</span></span>' +
                            '</p>' : ''}
                          </div>
